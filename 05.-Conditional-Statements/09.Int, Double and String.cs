...
Input
    On the first line you will receive the type of input as 
...
Output
    Write a single line on the console - the value transformed according
to the rules from the description.
    Print all double variables with exactly 2-digits precision 
after the floating point. Example: 0.99
Constraints
    ...
    static void Main(string[] args)
    {
        ...
        switch (input)
        {
            ...
            case "real":
                ...
                doubleVariable += 1;
                Console.WriteLine("{0:F2}", doubleVariable);
                break;
            case "text":
